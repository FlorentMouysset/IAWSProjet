...
public class TestIntegrationCovoiturageErr100EndPoint {
    ...
    public void covoiturageOkEndpoint() throws Exception {
    	Source requestPayload = new StreamSource(new ClassPathResource("CovoiturageRequest_add_100.xml").getInputStream() );
        Source responsePayload = new StreamSource(new ClassPathResource("Covoiturage_100.xml").getInputStream());
